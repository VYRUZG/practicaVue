<template>
  <HEAD>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Bebas+Neue&family=Bitcount+Grid+Single:wght@100..900&display=swap" rel="stylesheet">
  </HEAD>
  <div class="card-container">
    <div class="login-card">
      <form @submit.prevent="handleSubmit">
        <div class="imgcontainer">
          <img src="@/assets/login.png" alt="Mi imagen" style="width: 150px; height: auto;" />
        </div>

        <div class="container">
          <label for="email" class="bebas-neue-regular"><b>Email</b></label>
          <input
            type="text"
            v-model="email"
          ...
          <label for="psw" class="bebas-neue-regular "><b>Password</b></label>
          <input
            type="password"
            v-model="password"
        ...
        <button type="submit" style="display: flex; align-items: center; justify-content: center; gap: 8px;">
          ...
          <label class="bebas-neue-regular">
            <input type="checkbox" checked="checked" class="" name="remember"> recuerdame
          </label>
        </div>
